...
log_level = 'INFO'
work_dir = 'adzoo/drivetransformer/work_dirs/drivetransformer/drivetransformer_small.py/'
load_from = None
resume_from = None
workflow = [('train', 1)]
plugin = True
...
map_num_classes = 6
agent_query_num_vec = 200
agent_num_topk_sift = 200
agent_num_propagated = 20
map_query_num_vec = 50
map_num_topk_sift = 50
map_num_propagated = 20
memory_len_frame = 5
num_mode = 6
num_gpus = 1
batch_size = 2
num_iters_per_epoch = 100000
data_aug_conf = dict(
    resize_lim=(0.64, 0.69),
    final_dim=(384, 1056),
    bot_pct_lim=(0.0, 0.0),
...
optimizer = dict(type='AdamW', lr=3e-05, weight_decay=0.01)
...
lr_config = dict(
    ...
    warmup_ratio=0.1,
    min_lr_ratio=0.01)
runner = dict(type='IterBasedRunner', max_iters=3000000)
