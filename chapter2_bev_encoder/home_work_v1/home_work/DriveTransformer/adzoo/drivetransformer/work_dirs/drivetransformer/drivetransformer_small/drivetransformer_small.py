...
log_level = 'INFO'
work_dir = 'adzoo/drivetransformer/work_dirs/drivetransformer/drivetransformer_small/'
load_from = None
resume_from = None
workflow = [('train', 1)]
plugin = True
...
map_num_classes = 6
agent_query_num_vec = 196
agent_num_topk_sift = 196
agent_num_propagated = 20
map_query_num_vec = 49
...
lr_config = dict(
    ...
    warmup_ratio=0.1,
    min_lr_ratio=0.01)
runner = dict(type='IterBasedRunner', max_iters=6000000)
