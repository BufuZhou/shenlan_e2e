...
# Quick Training Configurations for 10-minute validation
...
num_gpus = 1
batch_size = 1
num_iters_per_epoch = 300  # Reduced for quick run
...
_dim_ = 256
total_epochs = 4  # Reduced for quick run
dropout = 0.1
...
lr_config = dict(
    ...
    warmup='linear',
    warmup_iters=500,  # Adjusted for shorter run
    warmup_ratio=1.0 / 10,
    min_lr_ratio=1e-2)
...
checkpoint_config = dict(interval=1200)  # Save at the end of the quick run
