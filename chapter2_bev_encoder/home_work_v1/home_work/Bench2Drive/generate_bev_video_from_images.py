...
if __name__ == "__main__":
    # 设置输入和输出路径
    base_path = "/root/project/shenlan_e2e/chapter2_bev_encoder/home_work_v1/home_work/Bench2Drive/visualization_results/drivetransformer_bench2drive_dev10_RouteScenario_3255_rep0_Town13_ParkingCrossingPedestrian_1_0_04_26_19_02_53"
    bev_folder = os.path.join(base_path, "bev")
    output_video = os.path.join(base_path, "bev_video.mp4")
